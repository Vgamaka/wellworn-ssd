...
import { useCurrency } from './CurrencyContext'; // Import the CurrencyContext hook
      ...
      {!loading && (
        <div className='men-main-container'>
          ...
          <p className='men-breadcrumb'>
            <Link to='/'>HOME</Link> <i className="fas fa-angle-right" /> <Link to="/new-arrivals">NEW ARRIVALS</Link><i className="fas fa-angle-right" />
          </p>
          <Filter
