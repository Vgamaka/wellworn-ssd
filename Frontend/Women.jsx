    ...
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = productsData.filter(product =>
          ...
          // Include Bags and Shoes in Women and Men & Women categories
          (product.Categories.includes("Bags") || product.Categories.includes("Shoes")) &&
          (product.Categories.includes("Women") || product.Categories.includes("Men & Women")) &&
          // Exclude products in Men and Exclusive categories
      ...
      {!loading && (
        <div className='men-main-container'>
          ...
          <p className='men-breadcrumb'>
            <Link to='/'>HOME</Link> <i className="fas fa-angle-right" /> <Link to="/women">WOMEN</Link><i className="fas fa-angle-right" />
          </p>
          <Filter
