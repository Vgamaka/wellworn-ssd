    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filteredProducts = productsData.filter(product =>
          ...
          // Include Men, Men & Women, and Shoes categories
      ...
      {!loading && (
        <div className='men-main-container'>
          ...
          <p className='men-breadcrumb'>
            <Link to='/'>HOME</Link> <i className="fas fa-angle-right" /> <Link to="/men-shoes">MEN SHOES</Link><i className="fas fa-angle-right" />
          </p>
          <Filter
