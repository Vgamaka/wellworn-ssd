    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filteredProducts = productsData.filter(product =>
          ...
          // Include Women, Men & Women, and Bags categories
      ...
      {!loading && (
        <div className='men-main-container'>
          ...
          <p className='men-breadcrumb'>
            <Link to='/'>HOME</Link> <i className="fas fa-angle-right" /> <Link to="/women-bags">WOMEN BAGS</Link><i className="fas fa-angle-right" />
          </p>
          <Filter
